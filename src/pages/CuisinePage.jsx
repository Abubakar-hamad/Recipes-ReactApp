        ...
        { cuisinex ?
              ...
              :
        ...
        </div>
               {
                isGre ?
                <>
                 <div onClick={showMore} className='flex gap-2 justify-center items-center bg-gradient-to-b from-gray-500 to-orange-300  my-3 w-72 mx-auto h-12 rounded-md opacity-50 hover:opacity-80 transition-opacity cursor-pointer'>
                    <span>
                    More
                    </span>
